...
<!--                                    <div class="row">
                ...
                <footer class="secondary-footer">
                    ...
                    <div class="container">
                        ...
                        <p class="copy-right">&#169; Copyright {{ date('Y') }}&nbsp;Royal Jayka</p>
                    </div>
                </footer>
            </div>
            <!-- end Footer Wrapper -->
        ...
        <script type="text/javascript" src="{{url('/')}}/js/fancySelect.js"></script>
        ...
        <script type="text/javascript" src="{{url('/')}}/js/instagram.min.js"></script>
