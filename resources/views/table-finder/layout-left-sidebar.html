...
<!-- Mirrored from crenoveative.com/envato/table-finder/layout-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Nov 2018 16:07:08 GMT -->
<head>
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							<li>
								...
								<ul>
									...
									<li><a href="index-05.html">Home Style 05</a></li>
									<li><a href="index-06.html">Home Style 06</a></li>
		...
		<div class="main-wrapper scrollspy-container">
			...
			<div class="hero hero-breadcrumb" style="background-image:url('images/hero-header/02.jpg');">
				...
				<div class="container">
					...
					<h1 class="text-left">Left sidebar layout page</h1>
			...
			<div class="container pt-10 pb-50">
				...
				<div class="breadcrumb-wrapper">
					<ol class="breadcrumb">
						...
						<li class="active">Left Sidebar Layout Page</li>
					</ol>
				</div>
				...
				<div class="mt-40">
					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-3 col-xs-12 mb-50-xs">
						
							<div class="section-title-02">
								<h4><span>Sidebar on Left</span></h4>
							</div>
						...
						<div class="col-sm-8 col-md-9 col-xs-12">
							...
							<div class="row">
								...
								<div class="col-md-8">
									...
									<div class="section-title-02">
										...
										<h3><span>Conent on right</span></h3>
							...
							<div class="row">
								...
								<div class="col-md-8">
									...
									<div class="section-title-02">
										...
										<h3><span>GridLex Grid System</span></h3>
							...
							<div class="GridLex-gap-20 mb-10">
							
								<div class="GridLex-grid-noGutter-equalHeight GridLex-grid-center">
								
									<div class="GridLex-col-2_sm-2_xs-4_xss-12">
									
										<div class="bg-primary text-center" style="padding: 50px 2px;">
											GridLex-col-2
										</div>
